...
def PGD_L1(mask, noises, **PGD_L1_opts):
    ...
    iter_num = PGD_L1_opts.get('iter_num', 2)
    lambda1 = PGD_L1_opts.get('lambda1', 0.07)
    ...
    result_name = testset_name + '_' + task_current + 'PGD L1'
    ...
    for idx, img in enumerate(L_paths):
        ...
        if n_channels == 1:
            img_H = img_H.squeeze()
        if save_E:
            util.imsave(img_E, os.path.join(E_path, img_name + 'PDG_L1.png'))
