"""
The definition is about the use of neural network denoising under the PNP-PGD-L1 framework
...
def PNP_PGD_L1_D(model_name, mask, noises, **PNP_PGD_L1_D_opts):
    ...
    for idx, img in enumerate(L_paths):
        ...
        img_L = util.uint2single(img_H)  # np.float32(img/255.)
        ...
        if n_channels == 1:
            img_H = img_H.squeeze()
        if save_E:
            util.imsave(img_E, os.path.join(E_path, img_name + '_' + model_name + 'PNP_PGD_L1.png'))
